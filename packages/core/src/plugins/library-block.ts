...
class PluginWidget extends WidgetType {
  ...
  override toDOM() {
    ...
    icon.setAttribute('class', this.block.type === 'plugin' ? 'icon-plugin' : 'icon-workflow');
